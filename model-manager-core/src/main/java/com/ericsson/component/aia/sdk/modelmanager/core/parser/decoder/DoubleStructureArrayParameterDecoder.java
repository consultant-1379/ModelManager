 ...
 * @author aia
 */
public class DoubleStructureArrayParameterDecoder extends GenericStructureArrayParameterDecoder {
     ...
     *            - event
     */
    public DoubleStructureArrayParameterDecoder(final EventParameter eventParameter) {
    ...
    public Object getDecodeValueForGenericRecord(final byte[] data, final int offset) {
        final Collection<Double> result = new ArrayList<Double>(eventParameter.getValidStructureArraySize());
    ...
    protected Object getDefaultValueForGenericRecord() {
        return doubleParameterDecoder.getDefaultValueForGenericRecord();
    }
