 ...
 * @author aia
 */
public class IBCDStructureArrayParameterDecoder extends GenericStructureArrayParameterDecoder {
     ...
     *            - event
     */
    public IBCDStructureArrayParameterDecoder(final EventParameter eventParameter) {
    ...
    protected Object getDefaultValueForGenericRecord() {
        return ibcdParameterDecoder.getDefaultValueForGenericRecord();
    }
}
